  ...
  return (
    <main className="min-h-screen bg-[#f9f9f7] text-[#1a1c1c]">
      <section className="relative overflow-hidden">
        ...
        <header className="sticky top-0 z-50 border-b border-[#d8d8d8]/80 bg-white/75 backdrop-blur-md">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-10">
            <BrandLogoLink priority imageClassName="h-9 w-auto md:h-10" />
            <div className="flex items-center gap-3">
              <Link
                href="/login"
                className="hidden text-sm font-medium text-[#181c22] transition-colors hover:text-[#4b39e6] sm:inline-flex"
              >
                Log in
              </Link>
              <ButtonLink
        ...
        <div className="mx-auto max-w-7xl px-4 pb-20 pt-14 md:px-10 md:pb-28 md:pt-20">
          <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
            <h1 className="font-display text-5xl font-bold leading-[1.02] tracking-[-0.03em] text-[#181c22] md:text-7xl">
              Get paid on time.
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              ...
              <ButtonLink
                href="/login"
                variant="secondary"
                className="rounded-full border border-[#d6d7db] bg-white px-8 py-4 text-base font-medium text-[#181c22] hover:bg-[#f3f3f4]"
              >
                See how it works
              </ButtonLink>
            </div>
          ...
          <div className="relative mx-auto mt-16 h-140 max-w-6xl">
            <div className="absolute left-1/2 top-1/2 z-20 w-full max-w-2xl -translate-x-1/2 -translate-y-1/2 rounded-[28px] border border-[#d8d8d8] bg-white p-8 shadow-[0_24px_50px_-22px_rgba(0,0,0,0.2)] md:p-10">
              <div className="flex flex-col gap-6 border-b border-[#e5e5e5] pb-8 md:flex-row md:items-start md:justify-between">
                <div>
                  <div className="text-xs font-semibold uppercase tracking-[0.22em] text-[#6b6e72]">
                    Invoice No.
                  </div>
                  <div className="mt-2 font-mono-ui text-2xl font-bold tracking-[-0.02em] text-[#181c22] md:text-3xl">
                    INV-2024-089
                  </div>
                </div>
              ...
              <div className="grid gap-8 py-8 md:grid-cols-2">
                <div>
                  ...
                  <div className="mt-4 flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-[#181c22]">
                        Marble Studio
                      </div>
                      <div className="text-sm text-[#6b6e72]">
                ...
                <div>
                  ...
                  <div className="mt-4 flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-[#181c22]">Charm AI</div>
                      <div className="text-sm text-[#6b6e72]">
                        billing@charm.ai
                      </div>
                    </div>
              ...
              <div className="flex items-end justify-between border-t border-[#e5e5e5] pt-8">
                <div className="text-base font-medium text-[#181c22] md:text-lg">
                  Total Amount Due
                </div>
                <div className="font-display text-3xl font-bold tracking-[-0.02em] text-[#181c22] md:text-4xl">
                  $12,500.00
                </div>
              </div>
            </div>

            <div className="absolute left-0 top-1/4 hidden w-72 -translate-y-1/4 -rotate-3 rounded-[20px] border border-[#d8d8d8] bg-white p-6 shadow-[0_20px_35px_-24px_rgba(0,0,0,0.3)] md:block">
              <h2 className="flex items-center gap-2 text-sm font-bold text-[#181c22]">
                  ...
                  const toneStyles =
                    item.tone === "success"
                      ...
                      : item.tone === "brand"
                        ...
                        : "border border-[#d8d8d8] bg-[#f3f3f4] text-[#6b6e72] ring-[#f9f9f7]";
            ...
            <div className="absolute bottom-1/4 right-0 hidden w-64 translate-y-1/4 rotate-2 rounded-[20px] border border-[#d8d8d8] bg-white p-5 shadow-[0_20px_35px_-24px_rgba(0,0,0,0.3)] md:block">
              ...
              <p className="mb-4 text-sm leading-6 text-[#4d5157]">
      ...
      >
        <h2 className="font-display text-center text-3xl font-bold tracking-[-0.02em] text-[#181c22] md:text-4xl">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {features.map((feature) => {
            ...
            return (
              <article
                key={feature.title}
                className="rounded-3xl border border-[#dfdfdf] bg-white p-8 shadow-[0_18px_40px_-30px_rgba(0,0,0,0.28)] transition-transform hover:-translate-y-1"
              >
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#e3dfff] text-[#4b39e6]">
                  <Icon className="h-6 w-6" />
                </div>
                <h3 className="font-display text-2xl font-bold tracking-[-0.02em] text-[#181c22]">
                  {feature.title}
                </h3>
                <p className="mt-3 text-base leading-7 text-[#4d5157]">
                  {feature.body}
                </p>
              </article>
            );
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3 text-sm text-[#6b6e72]">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#e1e1e1] bg-white px-4 py-2">
      ...
      <footer className="border-t border-[#d8d8d8] bg-[#181c22] text-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-12 md:flex-row md:items-center md:justify-between md:px-10">
          <div className="flex items-center gap-3">
            <BrandLogoLink imageClassName="h-9 w-auto brightness-0 invert" />
          </div>

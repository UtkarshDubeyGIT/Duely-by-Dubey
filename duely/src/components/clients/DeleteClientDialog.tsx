    ...
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-50 flex items-end bg-black/50 p-0 sm:items-center sm:justify-center sm:p-4">
          <div className="w-full rounded-t-2xl bg-white sm:max-w-sm sm:rounded-2xl">
            <div className="flex items-center justify-between border-b border-zinc-200 p-5">
              <h3 className="text-lg font-semibold text-zinc-950">Delete Client</h3>
            ...
            <div className="p-5">
              ...
              <div className="flex justify-end gap-2 border-t border-zinc-200 pt-4 mt-5">
